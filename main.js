        ...
        fs.readdir(customTemp, (err, files) => {
            ...
            for (const file of files) {
                ...
                fs.stat(filePath, (err, stats) => {
                    if (
                        !err &&
                        Date.now() - stats.mtimeMs > 3 * 60 * 60 * 1000
                    ) {
                        fs.unlink(filePath, () => {});
                    }
                });
    ...
    try {
        ...
        switch (true) {
            ...
            case userMessage.startsWith(".chatbot"):
                ...
                const chatbotAdminStatus = await isAdmin(
                    sock,
                    chatId,
                    senderId
                );
            ...
            case userMessage.startsWith(".fb") ||
                userMessage.startsWith(".facebook"):
            ...
            case userMessage.startsWith(".translate") ||
                ...
                const commandLength = userMessage.startsWith(".translate")
                    ? 10
                    : 4;
            ...
            case userMessage.startsWith(".oogway"):
                {
                    const parts = userMessage.trim().split(/\s+/);
                    const sub = userMessage.startsWith(".oogway2")
                        ? "oogway2"
                        : "oogway";
